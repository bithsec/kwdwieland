module.exports = {
  siteMetadata: {
    title: `KWD Wieland`,
    description: `Küchen- und Wohdesign Wieland Dominik`,
    siteUrl: `https://kwd-wieland.at`, // Replace with your domain name
    author: ``, // Replace with your twitter handle
  },
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        theme_color: `#7C3AED`,
        display: `minimal-ui`,
        icon: `src/images/kwd-favicon.png`, // Replace with your favicon (This path is relative to the root of the site)
      },
    },
    {
